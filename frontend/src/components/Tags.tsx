            ...
            <main className="flex-1 overflow-hidden w-full box-border bg-content-bg flex flex-col p-6">
                <div className="flex h-full w-full gap-6">
                            ...
                            {isLoadingTags ? (
                                ...
                                paginatedTags.map(tag => (
                                    <div
                                        ...
                                        className={`p-3 mb-2 rounded-lg cursor-pointer transition-colors hover:bg-gray-700 flex justify-between items-center ${selectedTag?.name === tag.name ? 'bg-blue-900/50 border border-blue-500' : 'bg-gray-800/50 border border-transparent'
                                            }`}
                                    >
                    ...
                    <div className="flex-1 flex flex-col gap-6 h-full">
                        ...
                        {/* TG_Card_02: Content List (Top Right) */}
                        ...
                        {/* TG_Card_03: Details (Bottom Right) */}
                                ...
                                <div className="h-full flex flex-col">
                                    ...
                                    <div className="flex-1 overflow-y-auto">
                                        <div className="mb-6">
                                            ...
                                            <div className="bg-gray-800/50 rounded-lg p-6 border border-gray-700 text-gray-300 leading-relaxed text-lg whitespace-pre-wrap">
                                                {detailContent}
                                            </div>
                                        </div>
